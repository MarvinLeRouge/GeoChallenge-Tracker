...
class UserStatsOut(BaseModel):
    ...
    first_cache_found_at: Optional[datetime] = Field(None, description="Date de la première cache trouvée")
    last_cache_found_at: Optional[datetime] = Field(None, description="Date de la dernière cache trouvée")
