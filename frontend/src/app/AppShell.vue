<template>
  <div class="min-h-screen flex flex-col bg-white text-gray-900">
    ...
    <!-- Contenu -->
    <main :class="route.meta?.dense ? 'p-0' : 'p-3 md:p-4'"
      ...
      >
        ...
        <nav class="p-3 space-y-6 overflow-auto">
          ...
          <div v-if="!isAuthenticated">
            <div class="text-xs font-semibold text-gray-500 mb-2 uppercase tracking-wider">Compte</div>
            <ul class="space-y-1">
              <li><RouterLink class="block px-3 py-3 rounded hover:bg-gray-100" to="/login">Connexion</RouterLink></li>
              <li><RouterLink class="block px-3 py-3 rounded hover:bg-gray-100" to="/register">Inscription</RouterLink></li>
            </ul>
          </div>
          ...
          <template v-else>
            <div>
              <button @click="toggle('account')" class="w-full flex items-center justify-between px-2 py-2 rounded hover:bg-gray-100" :aria-expanded="openSections.account">
              ...
              <ul v-show="openSections.account" class="space-y-1">
                <li>
                  <RouterLink
                    ...
                    to="/profile/location"
                  >
                    <MapPinIcon class="w-5 h-5 shrink-0 text-gray-700" aria-hidden="true" />
                ...
                <li>
                  ...
                  >
                    <ArrowLeftOnRectangleIcon class="w-5 h-5 shrink-0 text-gray-700" aria-hidden="true" />
            ...
            <!-- Caches -->
            <div>
              <button @click="toggle('caches')" class="w-full flex items-center justify-between px-2 py-2 rounded hover:bg-gray-100" :aria-expanded="openSections.account">
                <span class="flex items-center gap-2 text-xs font-semibold text-gray-500 mb-2 uppercase tracking-wider">
              ...
              <ul v-show="openSections.caches" class="space-y-1">
                <li>
                  <RouterLink
                    ...
                    class="flex items-center gap-2 px-3 py-3 rounded hover:bg-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-300"
                  >
                    <DocumentArrowUpIcon class="w-5 h-5 shrink-0 text-gray-700" aria-hidden="true" />
                ...
                <li>
                  <RouterLink
                    ...
                    to="/caches/by-filter"
                  >
                    <AdjustmentsHorizontalIcon class="w-5 h-5 shrink-0 text-gray-700" aria-hidden="true" />
                ...
                <li>
                  ...
                  >
                    <RectangleGroupIcon class="w-5 h-5 shrink-0 text-gray-700" aria-hidden="true" />
                ...
                <li>
                  ...
                  >
                    <RssIcon class="w-5 h-5 shrink-0 text-gray-700" aria-hidden="true" />
            ...
            <!-- Challenges -->
            <div>
              <button @click="toggle('challenges')" class="w-full flex items-center justify-between px-2 py-2 rounded hover:bg-gray-100" :aria-expanded="openSections.account">
                <span class="flex items-center gap-2 text-xs font-semibold text-gray-500 mb-2 uppercase tracking-wider">
              ...
              <ul v-show="openSections.challenges" class="space-y-1">
                <li>
                  <RouterLink
                    ...
                    class="flex items-center gap-2 px-3 py-3 rounded hover:bg-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-300"
                  >
                    <ArrowPathIcon class="w-5 h-5 shrink-0 text-gray-700" aria-hidden="true" />
                ...
                <li>
                  <RouterLink
                    ...
                    class="flex items-center gap-2 px-3 py-3 rounded hover:bg-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-300"
                  >
                    <Mountain class="w-5 h-5 shrink-0 text-gray-700" aria-hidden="true" />
            ...
            <!-- Targets -->
            <div>
              <button @click="toggle('targets')" class="w-full flex items-center justify-between px-2 py-2 rounded hover:bg-gray-100" :aria-expanded="openSections.account">
                <span class="flex items-center gap-2 text-xs font-semibold text-gray-500 mb-2 uppercase tracking-wider">
                  <Target class="w-4 h-4" aria-hidden="true" />
                  <span>Targets</span>
                </span>
              </button>
              <ul v-show="openSections.targets" class="space-y-1">
                <li>
                  <RouterLink
                    to="/my/targets"
                    class="flex items-center gap-2 px-3 py-3 rounded hover:bg-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-300"
                  >
                    <Target class="w-5 h-5 shrink-0 text-gray-700" aria-hidden="true" />
                ...
                <li>
                  <RouterLink
                    ...
                    class="flex items-center gap-2 px-3 py-3 rounded hover:bg-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-300"
                  >
                    <LocateFixed class="w-5 h-5 shrink-0 text-gray-700" aria-hidden="true" />
            ...
            <!-- Aide / FAQ -->
            <div>
                <button @click="toggle('help')" class="w-full flex items-center justify-between px-2 py-2 rounded hover:bg-gray-100" :aria-expanded="openSections.account">
                <span class="flex items-center gap-2 text-xs font-semibold text-gray-500 mb-2 uppercase tracking-wider">
              ...
              <ul v-show="openSections.help" class="space-y-1">
                <li>
                  <RouterLink
                    ...
                    class="flex items-center gap-2 px-3 py-3 rounded hover:bg-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-300"
                  >
                    <UserCircleIcon class="w-5 h-5 shrink-0 text-gray-700" aria-hidden="true" />
                    <span>Compte</span>
                  </RouterLink>
                </li>
                <li>
                ...
                <li>
                  <RouterLink
                    ...
                    class="flex items-center gap-2 px-3 py-3 rounded hover:bg-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-300"
                  >
                    <Trophy class="w-5 h-5 shrink-0 text-gray-700" aria-hidden="true" />
                    <span>Challenges</span>
                  </RouterLink>
                </li>
                <li>
        ...
        <footer class="border-t px-3 py-3">
          <RouterLink to="/legal" class="flex items-center gap-2 p-3 text-sm text-darkgray-500 hover:bg-gray-100">
...
import {
  Bars3Icon, XMarkIcon, UserCircleIcon, ArrowLeftOnRectangleIcon, Cog6ToothIcon, MapPinIcon,
  DocumentArrowUpIcon, AdjustmentsHorizontalIcon, RectangleGroupIcon, ArrowsPointingInIcon, RssIcon,
  CursorArrowRaysIcon, FlagIcon, ArrowPathIcon, ArrowTrendingUpIcon, ChartBarIcon, QuestionMarkCircleIcon,
