...
<template>
  ...
  <section class="max-w-screen-lg mx-auto space-y-12">
    <!-- HERO -->
    <header
      class="relative overflow-hidden rounded-2xl bg-gradient-to-b from-indigo-50 to-white ring-1 ring-indigo-100 p-6 md:p-10 text-center dark:from-indigo-950 dark:to-gray-900 dark:ring-indigo-900"
    >
      <h1 class="text-3xl md:text-4xl font-extrabold tracking-tight">
        GeoChallenge Tracker
      </h1>
      <p class="mt-3 text-gray-600 max-w-2xl mx-auto dark:text-gray-400">
      ...
      <div class="mt-6 flex flex-wrap items-center justify-center gap-3">
        <RouterLink
          ...
          to="/register"
          class="inline-flex items-center rounded-lg border px-4 py-2 font-medium hover:bg-white/60 backdrop-blur dark:border-gray-700 dark:hover:bg-gray-800/60"
        >
          Créer un compte
        </RouterLink>
        <RouterLink
        ...
        <a
          href="#how"
          class="inline-flex items-center rounded-lg border px-4 py-2 font-medium hover:bg-white/60 dark:border-gray-700 dark:hover:bg-gray-800/60"
        >
          Commencer
        </a>
      </div>
    ...
    <section id="how" class="space-y-6">
      ...
      <ol class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <!-- 1 -->
        <li
          class="group rounded-xl border p-4 hover:shadow-sm transition dark:border-gray-700"
        >
          <div class="flex items-start gap-3">
            <UserPlusIcon
              class="w-12 h-12 text-indigo-600 shrink-0 dark:text-indigo-400"
              aria-hidden="true"
            />
            <div>
          ...
          <div class="flex items-start gap-3">
            ...
            <div>
              <p class="font-semibold">
                3 - Détection automatique des challenges
              </p>
              <p class="text-sm text-gray-600 dark:text-gray-400">
                L’outil identifie automatiquement les caches challenges.
              </p>
            </div>
          </div>
        </li>
        ...
        >
          <div class="flex items-start gap-3">
            ...
            <div>
              <p class="font-semibold">
                6 - Suivi automatique de la progression
              </p>
              <p class="text-sm text-gray-600 dark:text-gray-400">
                Avancement, historique et date estimée d’achèvement.
              </p>
            </div>
          </div>
        </li>
        ...
        <!-- 7 -->
        <li
          class="group rounded-xl border p-4 hover:shadow-sm transition dark:border-gray-700 lg:col-span-3"
        >
          <div class="flex items-start gap-3">
            <MapIcon
              class="w-12 h-12 text-indigo-600 shrink-0 dark:text-indigo-400"
    ...
    <!-- TEASER / CTA -->
    <section
      class="text-center rounded-2xl border p-6 md:p-8 bg-gradient-to-b from-white to-indigo-50 dark:border-gray-700 dark:from-gray-900 dark:to-indigo-950"
    >
      ...
      <div class="mt-5 flex flex-wrap items-center justify-center gap-3">
        <RouterLink
          v-if="!isAuthenticated"
          to="/register"
          class="inline-flex items-center rounded-lg border px-4 py-2 font-medium hover:bg-white dark:border-gray-700 dark:hover:bg-gray-800"
        >
          Créer un compte
        </RouterLink>
        <RouterLink
    ...
    <section class="space-y-3">
      ...
      <p class="text-gray-600 text-sm text-center dark:text-gray-400">
        Guides rapides :
