      ...
      >
        <div class="flex items-center gap-2">
          ...
          <input
            ...
            min="0.1"
            step="0.1"
            class="border rounded px-2 py-1 w-20 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100"
          />
          <span>km</span>
          <button
            type="button"
        ...
        <p v-if="center" class="text-xs text-gray-600 mt-1 dark:text-gray-400">
          Centre: {{ centerDM
