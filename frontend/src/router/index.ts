...
const cachesRoutes = [
  ...
  },
  {
    ...
    meta: {
      dense: true,
      noFabPadding: true,
      title: "Caches - Zone géographique rectangulaire",
    },
  },
  {
    ...
    meta: {
      dense: true,
      noFabPadding: true,
      title: "Caches - Zone géographique circulaire",
    },
  },
  {
...
const challengesRoutes = [
  ...
  },
  {
    ...
    props: {
      title: "Progression",
      message: "Visualisation à venir.",
      helpTo: "/help/progression",
    },
...
router.beforeEach(async (to) => {
  ...
  // protégé ?
  const isPublic =
    PUBLIC_NAMES.has(String(to.name || "")) ||
